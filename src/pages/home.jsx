...
export default function Home({ articles }) {
  return (
    <>
      <Head>
        <title>Abdelrahman Abdelmoneim - Leader, Founder, and software engineer</title>
        <meta
          name="title"
      ...
      <Container className="mt-9">
        <div className="max-w-2xl">
          <h1 className="text-4xl font-bold tracking-tight text-zinc-800 dark:text-zinc-100 sm:text-5xl">
            Software Engineer and AI Enthusiast in Silicon Valley, CA.
          </h1>
          <p className="mt-6 text-base text-zinc-600 dark:text-zinc-400">
            I&apos;m Abdelrahman, full stack developer/software engineer. I am on my journey to exploring the world of Softwares and AI.
          </p>
