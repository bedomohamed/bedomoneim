...
const projects = [
  {
    name: 'SkylineDOOH: Digital Out of Home Advertising Platform',
    description:
      "Developed with Django, and Tailwind CSS for optimal UI/UX. Utilizes AWS, Docker, and CI/CD. Agile methodologies guide the development process, with designs in Figma and version control via GitHub.",
    link: {
      href: 'https://skylinedooh.com',
      label: 'Online',
    },
    logo: skyline,
  },
...
export default function Projects() {
  return (
    <>
      <Head>
        <title>Projects - Abdelrahman Abdelmoneim</title>
        <meta
          name="description"
